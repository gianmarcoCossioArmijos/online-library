...
const NewBookEnfermeria = () => {
  ...
  const {setEnfermeria} = useEnfermeria();
  ...
  return (
    <>
        <div className='form-base mx-auto my-12 self-center'>
          ...
          <h3 className='mt-3 mb-6 font-bold text-lg text-center'>Nuevo Libro de Enfermeria</h3>
...
export default NewBookEnfermeria