...
const NewBookAsistencia = () => {
    const [libro, setLibro] = useState({
        ...
        imagen: "",
        url: "",
        seccion: "librosAsistencia"
      });

  const {setAsistencia} = useAsistencia();
  ...
  return (
    <>
        <div className='form-base mx-auto my-12 self-center'>
          ...
          <h3 className='mt-3 mb-6 font-bold text-lg text-center'>Nuevo Libro de Asistencia</h3>
...
export default NewBookAsistencia